...
$RootMenu->AddMenuItem(8, "mi_tb_departemen", $Language->MenuPhrase("8", "MenuText"), "tb_departemenlist.php", 4, "", IsLoggedIn() || AllowListMenu('{32C4CE20-1B57-4C82-8475-08C0302816A6}tb_departemen'), FALSE, FALSE);
