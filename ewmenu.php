...
$RootMenu->AddMenuItem(3, "mi_tb_device", $Language->MenuPhrase("3", "MenuText"), "tb_devicelist.php", -1, "", IsLoggedIn() || AllowListMenu('{32C4CE20-1B57-4C82-8475-08C0302816A6}tb_device'), FALSE, FALSE);
